jQuery(document).ready(function() {
    ...
    var table_task_2_1 = $('#table_task_2_1').DataTable( {
        "stateSave": false,
        "processing": true,
        "serverSide": true,
        ...
        "ajax": {
            url: "/api/task_2_1",
            data: function (d) {
                d.type_processing = $('input[name=table_task_2_1_processing]:checked').val();
            }
        },
        "columns": [
    ...
    $('#table_task_2_1').data('datatable', table_task_2_1);

    $('input[name=table_task_2_1_processing]').on('change', function(e) {
        let table = $('#table_task_2_1').data('datatable');
        table.ajax.reload();
    });
